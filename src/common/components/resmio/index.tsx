...
export const ResmioForm = () => {
  useEffect(() => {
    ...
    script.src =
      "//static.resmio.com/static/en-gb/widget.js#height=600&width=400&fontSize=16px&backgroundColor=%23ffffff&color=%23555555&linkBackgroundColor=%23f5a623&facebookLogin=false&newsletterSignup=false&commentsDisabled=false&id=zaza-mediterannean-bbq-2";
    script.async = true;
  ...
  return (
    <main className=" w-screen h-screen">
      ...
      >
        <section
          className="px-3 my-3 w-full lg:w-1/2 lg:my-0 flex flex-col align-center text-center"
        ...
        <section
          ...
          data-testid="contact-section-1"
        >
          <div id="resmio-zaza-mediterannean-bbq-2">Resmio Booking System</div>
        </section>
      </div>
    </main>
  );
