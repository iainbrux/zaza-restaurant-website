...
export const NavigationBar = () => {
  return (
    <header>
      <nav
        className="flex flex-row items-center justify-center py-4 border-b-2 shadow-sm border-sky-500 fixed top-0 w-full bg-gradient-to-r from-violet-500 to-fuchsia-500s bg-black z-10"
        data-testid="navbar"
      >
        <Image
          alt="logo ipsum"
